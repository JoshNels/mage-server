...
export class LayerQuerier {
     ...
     */
    queryFeatureService(featureServiceConfig: FeatureServiceConfig, callback: (featureService: FeatureService, featureServiceConfig: FeatureServiceConfig) => void) {
     ...
     */
    private parseFeatureService(featureServiceConfig: FeatureServiceConfig, callback: (featureService: FeatureService, featureServiceConfig: FeatureServiceConfig) => void) {
        return (chunk: any) => {
            const service = JSON.parse(chunk) as FeatureService
